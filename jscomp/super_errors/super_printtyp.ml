(* taken from https://github.com/BuckleScript/ocaml/blob/d4144647d1bf9bc7dc3aadc24c25a7efa3a67915/typing/printtyp.ml *) 
(* unfortunately whole file's logic are pretty tied together; we had to copy
  paste the whole thing. In the future we might need to modify a few more of
  these anymore though. The modified section are commented as "modified" *)
